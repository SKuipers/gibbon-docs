...
The [update proceedure](administration/updating-gibbon.md) for stable and cutting edge code is nearly the same: the only variable is where you download the software from.
